...
namespace Tsp
{
    class Populasyon : List<Tur>
    {
        private Tur bestTour = null;
        ...
        public void CreateRandomPopulation(int populationSize, Sehirler cityList, Random rand, int chanceToUseCloseCity)
        {
            int firstCity, lastCity, nextCity;

            for (int tourCount = 0; tourCount < populationSize; tourCount++)
            {
                Tur tour = new Tur(cityList.Count);
